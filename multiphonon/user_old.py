...
#--- Ni  300 K at Pharos ------------------------------------------------------
Data           = "/SNS/ARCS/IPTS-7665/shared/olivier/pkl/sqe_Yb0.2CoSb3_55meV_300K.pkl"
MT             = "/SNS/ARCS/IPTS-7665/shared/olivier/pkl/sqe_Yb0.2CoSb3_55meV_300K.pkl"
C_ms           = arange(0.0,1.0,0.2)
backgroundFrac =    0.9
constantFrac   =    0.0
cutoff         =    3.0
elasticCutAvg  =    3
...
#--- Output settings ----------------------------------------------------------
interactive    = True
viewDirectory  = '/SNS/ARCS/IPTS-7665/shared/olivier/dos/tmp'
outputDir      = '/SNS/ARCS/IPTS-7665/shared/olivier/dos/tmp'
