...
class TestCase(unittest.TestCase):
    ...
    def test1(self):
        ...
        self.assertTrue(
            close_hist(
                ...
                hh.load(
                    os.path.join(here, "expected_results", "getdos-test1-final-dos.h5")
                ),
            )
        )
        return
    ...
    def test2(self):
        ...
        self.assertTrue(
            close_hist(
                ...
                hh.load(
                    os.path.join(here, "expected_results", "getdos-test2-final-dos.h5")
                ),
            )
        )
        return
    ...
    def test3(self):
        ...
        list(
            getDOS(
                os.path.join(datadir, "ARCS_V_annulus.nxs"), T=1.5, workdir="work-lowT"
            )
        )
        self.assertTrue(
            close_hist(
                ...
                hh.load(
                    os.path.join(here, "expected_results", "getdos-test3-final-dos.h5")
                ),
            )
        )
        return
