...
#sys.path.append('/home/lichen/danse/multiphonon/branches/maxCode/src')
...
if longE:
    sqe.cropForCalc(cutoff,eStop,elasticCutAvg,longE=longE)
else:
    sqe.cropForCalc(cutoff,eStop,elasticCutAvg,QHi=QHi,QLow=QLow)
sqe.norm2one()
sqe.expand(2.0)
sqe0 = expSqe(sqe)
...
cp.dump((sqe0,C_ms,res),\
         open( os.path.join( outputDir,"allCalcs.pkl") ,'wb'),-1)
